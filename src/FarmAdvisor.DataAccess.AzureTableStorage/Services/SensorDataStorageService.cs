...

{
    public class SensorDataStorageService : ISensorDataStorageService
    {
        ...
        //reading
        public async Task<SensorDataStorageEntity> GetEntityAsync(string SensorId, String LastForecastDate)
        {
            var tableClient = await GetTableClient();
            return await tableClient.GetEntityAsync<SensorDataStorageEntity>(SensorId, LastForecastDate);
        }
